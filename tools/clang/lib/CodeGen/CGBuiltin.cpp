...
Value *CodeGenFunction::EmitTargetBuiltinExpr(unsigned BuiltinID,
  ...
  case llvm::Triple::spir:
    return EmitSPIRBuiltinExpr(BuiltinID, E);
  default:
    return 0;
  }
}
...
Value *CodeGenFunction::EmitSPIRBuiltinExpr(unsigned BuiltinID,
                                           const CallExpr *E) {
   ...
   switch (BuiltinID)
   {
// Don't support abs as builtin. Need to overload for vector types in opencl
